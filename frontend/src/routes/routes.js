export const academicRoutes = [{ path: '/academic/courses', title: 'Courses' }, { path: '/academic/assignments', title: 'Assignments' }, { path: '/academic/grades', title: 'Grades & GPA' }, { path: '/academic/exams', title: 'Exams' }]
